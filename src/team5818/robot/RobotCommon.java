...
public class RobotCommon extends IterativeRobot {
    ...
    public final FlyWheel lowerFlywheel = addModule(new FlyWheel(new CANTalon(RobotConstants.TALON_FLYWHEEL_LOWER), true));
    public final FlyWheel upperFlywheel = addModule(new FlyWheel(new CANTalon(RobotConstants.TALON_FLYWHEEL_UPPER), false));
